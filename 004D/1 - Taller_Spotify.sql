...
CREATE TABLE ARTISTA(
    ...
    -- que el nombre no quede vacio
    -- Oyente_mensules no podria ser por que es un atributo deberiado por que se calcula 
    esta_verificado CHAR(1), -- Simular un boolean (y/n)
